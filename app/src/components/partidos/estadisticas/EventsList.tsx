...
const PlayerLink = ({ id, name }: { id: number | null, name: string | null }) => {
    if (!id || !name) return <span className="font-semibold text-sm md:text-base text-white truncate">{name || 'Equipo'}</span>;
    return (
