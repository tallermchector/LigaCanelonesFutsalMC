  ...
  return (
    <footer className="flex-shrink-0 border-t border-gray-700 bg-gray-800/50 p-2 backdrop-blur-sm">
        <div className="mx-auto w-full max-w-5xl">
            {/* Desktop Layout */}
            <div className="hidden md:flex flex-row items-stretch justify-center gap-2">
                ...
                <div className="flex flex-1 items-stretch justify-center gap-2 rounded-lg bg-gray-900/70 p-1 shadow-lg">
