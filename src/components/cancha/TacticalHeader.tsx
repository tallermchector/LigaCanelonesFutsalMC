  ...
  return (
    <header className="font-headline w-full max-w-4xl mx-auto flex flex-col items-center p-4">
      ...
      <div className="w-full text-white shadow-2xl rounded-lg overflow-hidden flex items-stretch justify-between h-auto md:h-24">
        ...
        {/* Score & Time */}
        <div className="flex items-center justify-center bg-primary text-xl md:text-3xl font-black px-2 md:px-4 gap-2 md:gap-4">
      ...
      <div className="w-full grid grid-cols-2 gap-4 px-4 md:px-8 mt-4">
          ...
          <div className="flex items-center justify-start gap-4 md:gap-8">
              ...
              <StatDisplay label="T.M." value={timeoutsA} icon={<Timer className="text-green-500" />} />
          </div>
          {/* Team 2 Stats */}
          <div className="flex items-center justify-end gap-4 md:gap-8">
              <StatDisplay label="T.M." value={timeoutsB} icon={<Timer className="text-green-500" />} />
