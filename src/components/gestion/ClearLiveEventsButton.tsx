  ...
  const handleClear = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: count > 0 
            ? `Se han eliminado ${count} eventos de la base de datos para los partidos en vivo.`
    ...
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <Button variant="destructive" disabled={isClearing}>
          ...
          {isClearing ? 'Limpiando...' : 'Limpiar Eventos (En Vivo)'}
        </Button>
      </AlertDialogTrigger>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Esta acción eliminará de la **base de datos** todos los eventos (goles, faltas, etc.)
            de los partidos que estén actualmente marcados como "En Vivo".
