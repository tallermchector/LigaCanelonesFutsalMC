        ...
        <div className="flex min-h-screen items-center justify-center text-center">
          <div className="max-w-5xl">
            <div className="relative">
              <h1
                className={`text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tight transition-all duration-1000 ease-out font-orbitron ${
                  isLoaded
            ...
            <p
              className={`mt-8 text-lg md:text-xl leading-relaxed text-muted-foreground max-w-3xl mx-auto transition-all duration-1000 ease-out ${
                isLoaded
                  ? 'opacity-100 translate-y-0'
                  : 'opacity-0 translate-y-8'
              }`}
            ...
            >
              <Link
                href="/partidos"
                className="group relative inline-block px-8 py-4 text-base sm:text-lg font-bold text-primary-foreground rounded-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:-translate-y-1 shadow-2xl hover:shadow-primary/25 w-full sm:w-auto"
              >
              ...
              <Link
                href="/posiciones"
                className="group relative inline-block px-8 py-4 text-base sm:text-lg font-bold text-foreground bg-background/50 backdrop-blur-sm rounded-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:-translate-y-1 shadow-2xl hover:shadow-white/10 w-full sm:w-auto border border-border"
              >
                <span className="relative z-10 flex items-center justify-center gap-2">
                  Ver Posiciones
                </span>
             ...
             <div
              className={`mt-16 flex flex-col items-center transition-all duration-1000 ease-out ${
                isLoaded
                  ? 'opacity-100 translate-y-0'
                  : 'opacity-0 translate-y-8'
              }`}
            ...
            >
              <p className="text-muted-foreground text-sm font-medium mb-2">Descubre más</p>
