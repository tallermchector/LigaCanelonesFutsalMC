...
export const ScoreboardHeader: React.FC<ScoreboardHeaderProps> = ({
  ...
  return (
    <div className={cn(
      ...
      <div className="relative p-4 md:p-6 grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] md:items-center gap-4 text-white">
        ...
        <div className="flex items-center justify-between md:justify-start gap-4">
          <div className="flex items-center gap-2 md:gap-4 flex-1">
            ...
            />
            <h2 className="text-xl md:text-3xl font-extrabold tracking-tight truncate">{team1Name}</h2>
          </div>
        ...
        <div className="text-center order-first md:order-none py-2">
        ...
        <div className="flex items-center justify-between md:justify-end gap-4">
          ...
          <div className="flex items-center gap-2 md:gap-4 flex-1 justify-end">
            <h2 className="text-xl md:text-3xl font-extrabold tracking-tight truncate text-right">{team2Name}</h2>
            <Image
